...
def get_news():
    ...
    url = f"https://newsapi.org/v2/everything?q=tesla&from=2023-04-12&sortBy=publishedAt&apiKey=ccf254217ebf46b2937e183349377ac4"
...
def listen():
    ...
    try:
        print("Recog......")
        text = R.recognize_google(audio, language='fr-in')
        print(">> ", text)
    except Exception:
...
class Main(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.Dspeak.started.connect(run)
        self.Dspeak.start()
        self.label.setPixmap(QPixmap("./lib/tuse.png"))
        self.label_5.setText(
            "<font size=8 color='white'>" + D + "</font>")
